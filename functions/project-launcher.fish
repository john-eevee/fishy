#!/usr/bin/env fish
# ==============================================================================
# PROJECT LAUNCHER (project-launcher.fish)
# ==============================================================================

set TARGET_DIR (find ~/code -mindepth 1 -maxdepth -type d | fzf --prompt="Select Project > " --height=40% --layout=reverse --border=rounded)
